...
class Snake(Canvas): 
    ...
    def __init__(self): 
        Canvas.__init__(self, width=WIDTH, height=HEIGHT, background="tomato", highlightthickness=0) 
        self.focus_get() 
    ...
    def loadResources(self): 
        ...
        self.body = ImageTk.PhotoImage(Image.open("images/body.png").resize((BODYSIZE, BODYSIZE))) 
        self.apple = ImageTk.PhotoImage(Image.open("images/apple.png").resize((BODYSIZE, BODYSIZE))) 
