...
class Snake(Canvas): 
    ...
    def __init__(self): 
        Canvas.__init__(self, width=WIDTH, height=HEIGHT, background="tomato") 
        self.focus_get() 
    ...
    def loadResources(self): 
        ...
        self.head = ImageTk.PhotoImage(self.headImage.resize((BODYSIZE, BODYSIZE)) )
        self.body = ImageTk.PhotoImage(Image.open("body.png").resize((BODYSIZE, BODYSIZE)) )
        self.apple = ImageTk.PhotoImage(Image.open("apple.png").resize((BODYSIZE, BODYSIZE))) 
    ...
    def gameOver(self):
        body = self.find_withtag("body")
        self.delete(ALL)
        self.create_text(self.winfo_width()/2,self.winfo_height()/2 - 60, text = 'You lose',
        fill = 'white', font = 'Tahoma 40',tag ='text')
        self.create_text(self.winfo_width()/2,self.winfo_height()/2, text = 'The lenght of snake is' + str(len(body)+1),
        fill = 'white', font = 'Tahoma 40',tag ='text')
        self.create_text(self.winfo_width()/2,self.winfo_height()/2 + 60, text = 'Pls Enter a space to play',
        fill = 'white', font = 'Tahoma 40',tag ='text')
